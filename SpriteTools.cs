...
public static class SpriteTools
{
    public static Vector3 ConstrainToScreen(SpriteRenderer spriteRenderer)
    {
        ...
        if (SpriteTop(spriteRenderer) > Screen.height - 100)
            screenPosition.y = (Screen.height - 100) - SpriteHalfHeight(spriteRenderer);
    ...
    public static Vector3 RandomLocationScreenSpace()
    {
        ...
        float randomY = Random.Range(0, Screen.height - 100);
